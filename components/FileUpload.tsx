...
const FileUpload: React.FC<FileUploadProps> = ({ onFileSelected }) => {
    ...
    return (
        ...
        >
            ...
            <p className="text-xl font-bold text-slate-300">اسحب وأفلت ملف ZIP هنا</p>
            <p className="text-slate-400 mt-2">أو <span className="text-cyan-400 font-semibold">انقر للاختيار</span></p>
        </div>
    );
};
